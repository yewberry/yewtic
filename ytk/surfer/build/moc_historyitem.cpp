...
static const char qt_meta_stringdata_HistoryItem[] = {
    "HistoryItem\0"
};

const QMetaObject HistoryItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_HistoryItem,
      qt_meta_data_HistoryItem, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_HistoryItem))
