...
**
** Created: Sun Jan 3 14:58:36 2010
...
static const char qt_meta_stringdata_DownloadManager[] = {
    "DownloadManager\0\0newItem()\0index\0"
    "itemDeleted(int)\0clearFinished()\0"
    "load()\0save()\0"
};

const QMetaObject DownloadManager::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_DownloadManager,
...
int DownloadManager::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: newItem(); break;
        case 1: itemDeleted((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: clearFinished(); break;
        case 3: load(); break;
        case 4: save(); break;
        default: ;
        }
...
// SIGNAL 0
void DownloadManager::newItem()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void DownloadManager::itemDeleted(int _t1)
{
